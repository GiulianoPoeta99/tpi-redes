...
export const getPacketRowClass = (pkt: Packet) => {
  ...
  switch (pkt.mode) {
    case 'receiver': return 'bg-purple-900/20 hover:bg-purple-900/30 text-gray-300';
    case 'transmitter': return 'bg-blue-900/20 hover:bg-blue-900/30 text-gray-300';
    case 'mitm': return 'bg-red-900/20 hover:bg-red-900/30 text-gray-300';
