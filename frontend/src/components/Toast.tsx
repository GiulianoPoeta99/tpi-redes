...
const Toast: React.FC<ToastProps> = ({ type, message, onClose }) => {
  ...
  return (
    <div
      className={`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow dark:text-gray-400 border ${colors[type]} transition-all animate-slide-in-right`}
    >
