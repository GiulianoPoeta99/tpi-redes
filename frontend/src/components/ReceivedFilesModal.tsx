    ...
    <AnimatePresence>
      {isOpen && (
        <React.Fragment>
          ...
          >
            <div className="bg-gray-900 border border-gray-700 rounded-xl w-full max-w-4xl max-h-[80vh] flex flex-col shadow-2xl pointer-events-auto overflow-hidden">
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-gray-800 bg-gray-900/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Browse and verify downloaded content</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex bg-gray-800 rounded-lg p-1 mr-2 border border-gray-800">
                    <button
                      onClick={() => setViewMode('grid')}
                      className={`p-1.5 rounded transition-all ${viewMode === 'grid' ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-500 hover:text-gray-300'}`}
                      type="button"
                      title="Grid View"
                    >
                      <LayoutGrid size={16} />
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded transition-all ${viewMode === 'list' ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-500 hover:text-gray-300'}`}
                      type="button"
                      title="List View"
                    >
                      <List size={16} />
