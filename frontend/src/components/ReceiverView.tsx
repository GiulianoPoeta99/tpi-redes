          ...
          <div className="flex-1 bg-gray-900/50 rounded-2xl border border-gray-700/50 flex flex-col items-center justify-center relative overflow-hidden shadow-inner">
            {!isConnected ? (
              ...
              <div className="w-full h-full p-4 relative">
                ...
                <SlidingWindow />
                <div className="absolute bottom-4 left-0 right-0 text-center text-status-success-text animate-pulse font-mono text-sm bg-black/50 py-1 backdrop-blur-md">
              ...
              <div className="text-center">
                <div className="relative">
                  <div className="absolute inset-0 bg-status-success-bg blur-xl opacity-20 animate-pulse"></div>
                  <Activity
                    size={64}
                    className="text-status-success-text relative z-10 mx-auto mb-6"
                  />
                </div>
